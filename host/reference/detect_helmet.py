...
nmsThreshold = 0.6   #Non-maximum suppression threshold // base is 0.5, set higher to avoid multiple boxes for same object.
inpWidth = 1216       #Width of network's input image    //smallest 320, 416, Can use 608 also, but slower.
inpHeight = 1216      #Height of network's input image   //smallest 320, 416, Can use 608 also, but slower.unknown_class 832
